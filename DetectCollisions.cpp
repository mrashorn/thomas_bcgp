...
bool Engine::detectCollisions(PlayableCharacter& character)
{
	...
	int endX = (int)(detectionZone.left / TILE_SIZE) + 2; // I think we / TILE_SIZE because we want to check using tiles, not pixel coordinates?
	...
	for (int x = startX; x < endX; x++)
	{
		for (int y = startY; y < endY; y++)
		{
			...
			// More collision detection here once we learn about particle effects
